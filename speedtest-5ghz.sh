...
log=/home/pi/logs/temp-speedtest-5ghz-bxl.log
result=/home/pi/logs/speedtest-5ghz-bxl.log
...
curl -X POST -H "Content-Type: application/json" -d "${json}" https://maker.ifttt.com/trigger/speedtest-5ghz/with/key/${secret_key}
