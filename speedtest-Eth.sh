...
log=/home/pi/logs/temp-speedtest-eth-bxl.log
result=/home/pi/logs/speedtest-eth-bxl.log
...
curl -X POST -H "Content-Type: application/json" -d "${json}" https://maker.ifttt.com/trigger/speedtest-eth/with/key/${secret_key}
